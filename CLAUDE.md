...
- **BoQ Rate Master + Rate Suggestion:** every invariant moved to `.claude/context/domain/boq-rate-master.md` -- load it before any rate-master work.
